...
int charStand[1],charRun[10],charJump[2],charRun1[4], charV[1],kunai[1],v1[1],v2[1],s1[1],s2[1],s3[1],obj[1],spaceShip[1],fire1[1],fire2[1],boss2[9];
...
} virus1(900,600,70,70,true,1),virus2(900,90,70,70,true,1),ku(140,120,32,20,true,30),ku1(140,120,32,20,true,30),virus3(900,400,50,50,true,.8),virus4(900,200,100,80,true,1),stone4(900,500,70,70,true,1),stone1(900,500,100,100,true,.5),stone2(900,300,100,100,true,.5),stone3(900,100,50,50,true,.4),fi1(140,300,40,20,true,100),fi5(140,300,40,20,true,100),fi2(900,305,70,70,true,100),fi3(900,305,70,70,true,100),fi4(900,305,70,70,true,100),BOSS(900,250,280,200, true, 100, 0),shield(900, 450, 50, 50,true, .6);//gem(140, 90, 100, 100, 3, 3, true, 0, 100,true);;
...
} player(140, 90, 100, 100, 0, 0, true, 0, 100),player2(140, 300, 100, 100, 0, 0, true, 10, 100);
...
void iDraw()
{
    ...
    if(g_Screen1==2)
    {
        ...
        if(bgIndex==0 && mode == 2 && player.score<=10)
        {
            for (int i=0; i<10; i++)
            {
        ...
        {*/
        if(bgIndex==0 && mode == 2 &&(player.score>=10 && player2.score<=30))
        {
        ...
        if(bgIndex==0 && mode == 2 && player2.score>=30)
        {
...
void showVirus()
{
    ...
    iShowImage(virus2.x,virus2.y,virus2.charDimensionX,virus2.charDimensionY,charV[0]);
